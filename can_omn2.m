...
%             camino simple
%
function [num_can,Cannib,num_omn,Omniv]=can_omn2(A)
%
S=size(A,1);
G=digraph(A);
% 
% canibalismo:    num_can=(1/S)*sum(diag(A));
...
% con esto elimino los ceros de omn_pos   :   d(d==0)=[]   
Omniv(Omniv == 0)=[];
num_omn=size(Omniv,2);
%
%
